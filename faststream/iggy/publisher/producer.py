...
if TYPE_CHECKING:
    from aiokafka import AIOIggyProducer

    from faststream.types import SendableMessage


class AioIggyFastProducer(ProducerProto):
    """A class to represent Iggy producer."""

    _producer: Optional["AIOIggyProducer"]

    def __init__(
        self,
        producer: "AIOIggyProducer",
    ) -> None:
