...
class BaseIggyTelemetrySettingsProvider(TelemetrySettingsProvider[MsgType]):
...
class IggyTelemetrySettingsProvider(
    BaseIggyTelemetrySettingsProvider["ConsumerRecord"]
):
...
class BatchIggyTelemetrySettingsProvider(
    BaseIggyTelemetrySettingsProvider[Tuple["ConsumerRecord", ...]]
):
    def get_consume_attrs_from_message(
        self,
...
def telemetry_attributes_provider_factory(
    ...
    IggyTelemetrySettingsProvider,
    BatchIggyTelemetrySettingsProvider,
]:
    if isinstance(msg, Sequence):
        return BatchIggyTelemetrySettingsProvider()
    else:
        return IggyTelemetrySettingsProvider()
