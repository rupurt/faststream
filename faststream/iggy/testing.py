...
from faststream.kafka.broker import IggyBroker
...
__all__ = ("TestIggyBroker",)


class TestIggyBroker(TestBroker[IggyBroker]):
    """A class to test Iggy brokers."""
...
class FakeProducer(AioIggyFastProducer):
    """A fake Iggy producer for testing purposes.

    This class extends AioIggyFastProducer and is used to simulate Iggy message publishing during tests.
    """

    def __init__(self, broker: IggyBroker) -> None:
        self.broker = broker
    ...
    async def publish(  # type: ignore[override]
        ...
        *,
        ...
        """Publish a message to the Iggy broker."""
    ...
    async def publish_batch(
        ...
        *msgs: "SendableMessage",
        ...
        """Publish a batch of messages to the Iggy broker."""
        for handler in self.broker._subscribers.values():  # pragma: no branch
...
def build_message(
    ...
    *,
    ...
    """Build a Iggy ConsumerRecord for a sendable message."""
