...
from faststream.kafka.broker.registrator import IggyRegistrator
...
if TYPE_CHECKING:
    ...
    from faststream.kafka.message import IggyMessage
    from faststream.types import SendableMessage


class IggyPublisher(ArgsContainer):
    """Delayed IggyPublisher registration object.

    Just a copy of `IggyRegistrator.publisher(...)` arguments.
    """
...
class IggyRoute(SubscriberRoute):
    """Class to store delayed IggyBroker subscriber registration."""
    ...
    def __init__(
        ...
        *topics: Annotated[
            str,
            Doc("Iggy topics to consume messages from."),
        ],
        publishers: Annotated[
            Iterable[IggyPublisher],
            Doc("Iggy publishers to broadcast the handler result."),
        ] = (),
        batch: Annotated[
            bool,
        ...
        heartbeat_interval_ms: Annotated[
            ...
            Iggy's group management feature. Heartbeats are used to ensure
        ...
        middlewares: Annotated[
            Iterable["SubscriberMiddleware[IggyMessage]"],
...
class IggyRouter(
    ...
    """Includable to IggyBroker router."""
