...
from faststream.kafka.broker.broker import IggyBroker as KB
...
class IggyRouter(StreamRouter[Union[ConsumerRecord, Tuple[ConsumerRecord, ...]]]):
    """A class to represent a Iggy router."""
    ...
    def subscriber(
        self,
        *topics: Annotated[str, Doc("Iggy topics to consume messages from.")],
        group_id: Annotated[
            Optional[str],
            Doc(
                """
